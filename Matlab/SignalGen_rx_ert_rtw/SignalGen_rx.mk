...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/SignalGen_rx.out
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = TI C28x
MODELREF_LINK_RSPFILE_NAME = SignalGen_rx_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SignalGen_rx.out
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/SignalGen_rx_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -IC:/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/tic2000/src -I$(MATLAB_ROOT)/toolbox/target/extensions/processor/tic2000/include -I$(MATLAB_ROOT)/toolbox/rtw/targets/common/can/blocks/tlc_c -IC:/MATLAB/SupportPackages/R2016a/toolbox/target/supportpackages/tic2000/inc -IC:/ti/controlSUITE/device_support/f2806x/v141/F2806x_common/include -IC:/ti/controlSUITE/device_support/f2806x/v141/F2806x_headers/include -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil
...
DEFINES_ = -DMODEL=SignalGen_rx -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=1 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DSTACK_SIZE=512
...
DEFINES_STANDARD = -DMODEL=SignalGen_rx -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO
...
%.obj : $(START_DIR)/SignalGen_rx_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/SignalGen_rx_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/SignalGen_rx_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/SignalGen_rx_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
