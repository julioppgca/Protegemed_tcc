...
#define PTGM_CONTENT_TYPE   "application/x-www-form-urlencoded"//"application/octet-stream" //"application/x-www-form-urlencoded" // Protegemed content type
