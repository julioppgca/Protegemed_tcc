...
linker.cmd: package/cfg/RTOS_config_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/RTOS_config_pem4fcfg.cmd\)\"$""\"C:/Users/skelter_win/Protegemed_tcc/TM4C_Protegemed/.config/xconfig_RTOS_config/\1\""' package/cfg/RTOS_config_pem4f.xdl > $@
